...
//	}
	...
	/**
	 * Returns an aspect where an entity must possess all of the specified component
	 * types.
	 *
	...
	/**
	 * Returns an aspect where an entity must possess one of the specified component
	 * types.
	 *
	...
	public static class Builder {
		...
		private static void associate(ComponentIDFactory componentIDFactory, Bag<Class<? extends Component>> types,
				BitVector componentBits) {
			for (Class<? extends Component> t : types) {
				componentBits.set(componentIDFactory.getComponentIDFor(t));
			}
		}
		...
		public String toString() {
			return "Aspect[" + "all=" + append(allTypes) + ", one=" + append(oneTypes) + ", exclude="
					+ append(exclusionTypes) + ']';
		}
